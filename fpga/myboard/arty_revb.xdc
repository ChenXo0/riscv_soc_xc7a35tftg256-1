...
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS25 } [get_ports { clk50mhz }]; #IO_L12P_T1_MRCC_35 Sch=gclk[100]
create_clock -add -name sys_clk_pin -period 20.00 -waveform {0 10} [get_ports { clk50mhz }];

# Clock routing constraint for PLL
#set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets u_pll/clkref_buffered_w]
...
set_property -dict { PACKAGE_PIN K12    IOSTANDARD LVCMOS25 } [get_ports { led[0] }]; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN L14    IOSTANDARD LVCMOS25 } [get_ports { led[1] }]; #IO_25_35 Sch=led[5]
set_property -dict { PACKAGE_PIN L13    IOSTANDARD LVCMOS25 } [get_ports { led[2] }]; #IO_L24P_T3_A01_D17_14 Sch=led[6]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS25 } [get_ports { led[3] }]; #IO_L24N_T3_A00_D16_14 Sch=led[7]
...
set_property -dict { PACKAGE_PIN C7   IOSTANDARD LVCMOS25 } [get_ports { uart_rxd_out }]; #IO_L19N_T3_VREF_16 Sch=uart_rxd_out CH340
set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVCMOS25 } [get_ports { uart_txd_in }]; #IO_L14N_T2_SRCC_16 Sch=uart_txd_in
...
##DDR3 pins
## DDR3 SDRAM Constraints

# DDR3 Address pins
set_property -dict { PACKAGE_PIN C11     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[0] }];
set_property -dict { PACKAGE_PIN A12     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[1] }];
set_property -dict { PACKAGE_PIN D9     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[2] }];
set_property -dict { PACKAGE_PIN A15     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[3] }];
set_property -dict { PACKAGE_PIN B12     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[4] }];
set_property -dict { PACKAGE_PIN C9     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[5] }];
set_property -dict { PACKAGE_PIN B11     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[6] }];
set_property -dict { PACKAGE_PIN D8     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[7] }];
set_property -dict { PACKAGE_PIN B10     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[8] }];
set_property -dict { PACKAGE_PIN C8     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[9] }];
set_property -dict { PACKAGE_PIN C12     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[10] }];
set_property -dict { PACKAGE_PIN A9     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[11] }];
set_property -dict { PACKAGE_PIN B14     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[12] }];
set_property -dict { PACKAGE_PIN A8     IOSTANDARD SSTL15 } [get_ports { ddr3_addr[13] }];

set_property INTERNAL_VREF 0.675 [get_iobanks 15];

# DDR3 Bank Address pins
set_property -dict { PACKAGE_PIN C14     IOSTANDARD SSTL15 } [get_ports { ddr3_ba[0] }];
set_property -dict { PACKAGE_PIN A13     IOSTANDARD SSTL15 } [get_ports { ddr3_ba[1] }];
set_property -dict { PACKAGE_PIN B15     IOSTANDARD SSTL15 } [get_ports { ddr3_ba[2] }];

# DDR3 Control pins
set_property -dict { PACKAGE_PIN D13     IOSTANDARD SSTL15 } [get_ports { ddr3_cas_n }];
set_property -dict { PACKAGE_PIN C16     IOSTANDARD SSTL15 } [get_ports { ddr3_ras_n }];
set_property -dict { PACKAGE_PIN B16     IOSTANDARD SSTL15 } [get_ports { ddr3_we_n }];
set_property -dict { PACKAGE_PIN D10     IOSTANDARD SSTL15 } [get_ports { ddr3_reset_n }];
...
# DDR3 CKE and CS pins
set_property -dict { PACKAGE_PIN A14     IOSTANDARD SSTL15 } [get_ports { ddr3_cke[0] }];
# set_property -dict { PACKAGE_PIN A10     IOSTANDARD SSTL15 } [get_ports { ddr3_cs_n[0] }];

# DDR3 ODT pin
set_property -dict { PACKAGE_PIN C13     IOSTANDARD SSTL15 } [get_ports { ddr3_odt[0] }];

# DDR3 Data Mask pins
set_property -dict { PACKAGE_PIN F12     IOSTANDARD SSTL15 } [get_ports { ddr3_dm[0] }];
set_property -dict { PACKAGE_PIN G16     IOSTANDARD SSTL15 } [get_ports { ddr3_dm[1] }];

# DDR3 Data pins
set_property -dict { PACKAGE_PIN F15     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[0] }];
set_property -dict { PACKAGE_PIN F13     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[1] }];
set_property -dict { PACKAGE_PIN E15     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[2] }];
set_property -dict { PACKAGE_PIN E13     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[3] }];
set_property -dict { PACKAGE_PIN D16     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[4] }];
set_property -dict { PACKAGE_PIN E11     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[5] }];
set_property -dict { PACKAGE_PIN E16     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[6] }];
set_property -dict { PACKAGE_PIN E12     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[7] }];
set_property -dict { PACKAGE_PIN H13     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[8] }];
set_property -dict { PACKAGE_PIN H16     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[9] }];
set_property -dict { PACKAGE_PIN G15     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[10] }];
set_property -dict { PACKAGE_PIN H14     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[11] }];
set_property -dict { PACKAGE_PIN H12     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[12] }];
set_property -dict { PACKAGE_PIN J15     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[13] }];
set_property -dict { PACKAGE_PIN G12     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[14] }];
set_property -dict { PACKAGE_PIN J16     IOSTANDARD SSTL15 } [get_ports { ddr3_dq[15] }];

# DDR3 Data Strobe pins
set_property -dict { PACKAGE_PIN D14     IOSTANDARD DIFF_SSTL15 } [get_ports { ddr3_dqs_p[0] }];
set_property -dict { PACKAGE_PIN G14     IOSTANDARD DIFF_SSTL15 } [get_ports { ddr3_dqs_n[0] }];
set_property -dict { PACKAGE_PIN D15     IOSTANDARD DIFF_SSTL15 } [get_ports { ddr3_dqs_p[1] }];
set_property -dict { PACKAGE_PIN F14     IOSTANDARD DIFF_SSTL15 } [get_ports { ddr3_dqs_n[1] }];

#set_property IOSTANDARD DIFF_SSTL15 [get_ports { ddr3_ck_p[0] ddr3_ck_n[0] ddr3_dqs_p[*] ddr3_dqs_n[*] }]

# 强制其余 DDR3 端口使用 SSTL15（地址/片选/控制/复位/ODT/DM/DQ 等）

#set_property IOSTANDARD SSTL15 [get_ports { ddr3_reset_n ddr3_ras_n ddr3_cas_n ddr3_we_n ddr3_cke[0] ddr3_cs_n[0] ddr3_odt[0] ddr3_ba[*] ddr3_addr[*] ddr3_dm[*] ddr3_dq[*] }]