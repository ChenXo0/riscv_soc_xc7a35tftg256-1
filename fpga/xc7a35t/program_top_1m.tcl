...
set bitfile "E:/fpga/repo/riscv_soc/fpga/xc7a35t/top.bit"
set ltxfile "E:/fpga/repo/riscv_soc/fpga/xc7a35t/top.ltx"
...
if {[llength $hw_axis] > 0} {
    ...
    puts "CONSOLE0=[run_axi_read $hw_axi $CONSOLE_ADDR]"
}
