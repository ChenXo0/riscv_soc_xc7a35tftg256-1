...
puts "TARGET_BEFORE_FREQ=[get_property PARAM.FREQUENCY $tgt]"
set_property PARAM.FREQUENCY 125000 $tgt
puts "TARGET_AFTER_FREQ=[get_property PARAM.FREQUENCY $tgt]"
close_hw_target
open_hw_target
...
puts "PROGRAM_DONE"
foreach delay {0 500 1000 2000 5000} {
    if {$delay > 0} { after $delay }
    refresh_hw_device -update_hw_probes false $hw_dev
    dump_status [format {AFTER_%dMS} $delay] $hw_dev
}
close_hw_manager
exit 0
